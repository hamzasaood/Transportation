...
p.texting {  
color: #FFFFFF;
font: normal normal bold 21px/17px Rajdhani;
}
}
@media screen and ( max-width: 1024px ) {
a.rr {  
...
div.ms {  
background-position:center;background-size:100% 60% ;
}
}
.ms{
...
@endif
	  ...
	  <br><br><br><br><br><br>
        ...
        <div class="bg-holder ms" style="
		background-image:url({{asset ('app-assets/assets/img/gallery/Landingpage.png)')}};     background-position: center;
    width:100%;
"></div>
        <!--/.bg-holder-->
        <div class="container">
          ...
          <div class="row align-items-center min-vh-50 min-vh-sm-100">
           ...
           <div class="col-md-4 col-lg-4 text-md-start text-center">
              <p  class="texting">Your awesome traffic <br /> permit consultant.</p><a class="btn btn-primary rr" href="{{url('book')}}" role="button">GET STARTED<svg class="bi bi-arrow-right" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
The occupational traffic permit is one of the most important things in the company when carrying out freight transport. In fact, it is a prerequisite for doing business traffic at all. </p>
              <div class="card card-span bg-soft-primary border-start border-primary border-5 mt-3">
                <div class="card-body">
                  <h4 class="lh-base px-lg-5 py-3" style="letter-spacing: 0px;color: #2E3191;opacity: 1;">
      ...
      <section>
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-center mb-6 mb-md-0"><img class="w-100" src="{{asset ('app-assets/assets/img/gallery/Group8902.png')}}" alt="..." /></div>
            <div class="col-md-6 text-center text-md-start mb-6 px-4">
              <h4 class="text-uppercase" style="letter-spacing: 0px;color: #EE8F1C;">Book transportation</h4>
              <p class="my-5 fs-1 pe-xl-7" style="font: normal normal normal 27px/41px Helvetica Neue LT;
letter-spacing: 0.76px;
color: #2E3191;opacity: 1;">
When applying for a traffic permit, there are certain requirements that you must meet that are included in the examination: requirements for professional knowledge, solid establishment, good reputation and financial resources. Important to remember is to confirm your application for a traffic permit by the company's company signer or CEO.</p>
               <a href="{{url('book')}}"><button class="btn btn-primary" >Book Now</button></a></div>           
      ...
      <section class="bg-primary-gradient" id="faq">
        <div class="bg-holder" style="background-image:url({{asset ('app-assets/assets/img/gallery/faq-bg.png')}});background-position:right;background-size:contain;"></div>
        <!--/.bg-holder-->
        <div class="container">
          <div class="row flex-center">
            <div class="col-md-6">
              <h4 style="text-align: left;
font: normal normal bold 33px/31px Helvetica Neue LT;
letter-spacing: 0px;
color: rgba(247, 148, 29, 1);
opacity: 1;">Track Order</h4><br>
              <h1  style="text-align: left;

letter-spacing: 1.46px;
color: rgba(46, 49, 145, 1);
opacity: 1;">Keep an Eye on your <br class="d-none d-lg-block" />Orders by our Tracking System</h1><br class="d-none d-lg-block" />
			
<a href="{{url('track')}}"><button class="btn btn-primary">Track Order</button></a>
            </div>
            <div class="col-md-6"><img class="w-100" src="{{asset ('app-assets/assets/img/gallery/Group8692.png')}}" alt="..." /></div>
          </div>
...
function scrollFunction() {
  if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
    document.getElementById("nav").style.background = "rgba(247, 148, 29, 1)";
